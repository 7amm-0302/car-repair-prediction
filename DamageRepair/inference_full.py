...
# 문경 YOLO 경로
YOLO_MODEL_PATH = os.path.join(BASE_DIR, "..", "Yolo", "model", "best.pt")
#r"..\Yolo\model\best.pt"

# 세영 모델 경로
SEGMENTATION_MODEL_PATH = os.path.join(BASE_DIR, "model", "best_segmentation_model.pth")
SEGMENTATION_CLASSES_PATH = os.path.join(BASE_DIR, "model", "segmentation_classes.json")
REPAIR_MODEL_PATH = os.path.join(BASE_DIR, "model", "best_repair_model.pth")
REPAIR_CLASSES_PATH = os.path.join(BASE_DIR, "model", "repair_classes.json")
